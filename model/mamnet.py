...
from utils.layers import atten_Up
...
class MamNet(nn.Module):
    def __init__(self, inchannel, num_class,bin=[1,4]):
        ...
        self.up1 = atten_Up(1024,512,is_deconv= True )
        self.up2 = atten_Up(512, 256,is_deconv= True )
        self.up3 = atten_Up(256, 128,is_deconv= True )
